...
pub const DefaultWalker = WalkerType(.{ .max_dir_handles = 1024 });

pub fn walker(root: []const u8, subpath: []const u8) DefaultWalker {
...
pub fn WalkerType(comptime config: WalkerConfig) type {
    return struct {
        ...
        pub const Entry = struct {
            ...
            pub fn realpathAlloc(self: Entry, allocator: mem.Allocator) ![]const u8 {
                return try self.dir.realpathAlloc(allocator, self.subpath);
            }
